...
public class CEquiposLab2 extends JFrame implements ActionListener {
    ...
    public CEquiposLab2() {
        ...
        // Título
        JLabel lblTitulo = new JLabel("CONTROL DE EQUIPOS - LAB 2", SwingConstants.CENTER);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnMonitor) {
            ...
            CEMonitorLab2 monitorLab2 = new CEMonitorLab2();  // Abre la ventana de Control de Monitores para LAB 1
            monitorLab2.setVisible(true);
        }else if (e.getSource() == btnVolver) {
            this.dispose();  // Cierra la ventana actual
            MenuControlEquipos menu = new MenuControlEquipos();  // Vuelve al menú de control de equipos
            menu.setVisible(true);
        } else if (e.getSource() == btnCpu) {
            JOptionPane.showMessageDialog(this, "CPU seleccionado en LAB 2.");
        } else if (e.getSource() == btnTeclado) {
            JOptionPane.showMessageDialog(this, "Teclado seleccionado en LAB 2.");
        }
    }

    public static void main(String[] args) {
        CEquiposLab2 cEquiposLab2 = new CEquiposLab2();
        cEquiposLab2.setVisible(true);
    }
}
