...
public class CEquiposLab5 extends JFrame implements ActionListener {

    JButton btnMonitor, btnCpu, btnTeclado, btnPizarra, btnVolver;

    public CEquiposLab5() {
        setTitle("Control de Equipos - LAB 5");
        setSize(400, 450);  // Ajustamos el tamaño de la ventana
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(null);

        // Título
        JLabel lblTitulo = new JLabel("CONTROL DE EQUIPOS - LAB 5", SwingConstants.CENTER);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnVolver) {
            ...
            JOptionPane.showMessageDialog(this, "Monitor seleccionado en LAB 5.");
        } else if (e.getSource() == btnCpu) {
            JOptionPane.showMessageDialog(this, "CPU seleccionado en LAB 5.");
        } else if (e.getSource() == btnTeclado) {
            JOptionPane.showMessageDialog(this, "Teclado seleccionado en LAB 5.");
        } else if (e.getSource() == btnPizarra) {
            JOptionPane.showMessageDialog(this, "Pizarra Digital seleccionada en LAB 5.");
        }
    }

    public static void main(String[] args) {
        CEquiposLab5 cEquiposLab5 = new CEquiposLab5();
        cEquiposLab5.setVisible(true);
    }
}
