...
public class CEquiposLab4 extends JFrame implements ActionListener {

    JButton btnMonitor, btnCpu, btnTeclado, btnVolver;

    public CEquiposLab4() {
        setTitle("Control de Equipos - LAB 4");
        setSize(300, 400);  // Tamaño reducido de la ventana
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(null);

        // Título
        JLabel lblTitulo = new JLabel("CONTROL DE EQUIPOS - LAB 4", SwingConstants.CENTER);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnVolver) {
            ...
            JOptionPane.showMessageDialog(this, "Monitor seleccionado en LAB 4.");
        } else if (e.getSource() == btnCpu) {
            JOptionPane.showMessageDialog(this, "CPU seleccionado en LAB 4.");
        } else if (e.getSource() == btnTeclado) {
            JOptionPane.showMessageDialog(this, "Teclado seleccionado en LAB 4.");
        }
    }

    public static void main(String[] args) {
        CEquiposLab4 cEquiposLab4 = new CEquiposLab4();
        cEquiposLab4.setVisible(true);
    }
}
